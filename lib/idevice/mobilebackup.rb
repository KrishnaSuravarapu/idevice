...
module Idevice
  ...
  module C
    ...
    attach_function :mobilebackup_request_restore, [MobileBackupClient, Plist_t, :mobilebackup_flags_t, :string],
                    :mobilebackup_error_t
    ...
    attach_function :mobilebackup_receive_restore_application_received, [MobileBackupClient, :pointer],
                    :mobilebackup_error_t
