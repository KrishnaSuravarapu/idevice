...
module Idevice
  ...
  class DiagnosticsRelayClient < C::ManagedOpaquePointer
    ...
    def self.attach(opts = {})
      ...
      FFI::MemoryPointer.new(:pointer) do |p_drc|
        ...
        raise DiagnosticsRelayError,
              "diagnostics_relay_client_new returned a NULL diagnostics_relay_client_t pointer" if drc.null?
  ...
  module C
    ...
    attach_function :diagnostics_relay_client_new, [Idevice, LockdownServiceDescriptor, :pointer],
                    :diagnostics_relay_error_t
    ...
    attach_function :diagnostics_relay_request_diagnostics, [DiagnosticsRelayClient, :string, :pointer],
                    :diagnostics_relay_error_t
    ...
    attach_function :diagnostics_relay_query_mobilegestalt, [DiagnosticsRelayClient, Plist_t, :pointer],
                    :diagnostics_relay_error_t
    ...
    attach_function :diagnostics_relay_query_ioregistry_entry, [DiagnosticsRelayClient, :string, :string, :pointer],
                    :diagnostics_relay_error_t
    ...
    attach_function :diagnostics_relay_query_ioregistry_plane, [DiagnosticsRelayClient, :string, :pointer],
                    :diagnostics_relay_error_t
  end
end
